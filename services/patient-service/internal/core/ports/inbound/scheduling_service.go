...
type SchedulingService interface {
	...
	DispatchDueMeetingReminders(ctx context.Context, limit int32) (int, error)
	...
	ConnectBridgedCall(ctx context.Context, sessionID string, actor models.ScheduleActor, participantIdentity string, joinMode string, accessToken string) (*models.BridgedCallConnectResult, error)
