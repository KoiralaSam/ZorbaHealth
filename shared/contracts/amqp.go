...
const (
	...
	// Appointment events (appointment.event.*)
	AppointmentEventBooked    = "appointment.event.booked"
	AppointmentEventCancelled = "appointment.event.cancelled"
	AppointmentEventRescheduled = "appointment.event.rescheduled"
